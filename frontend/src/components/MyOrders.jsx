...
const calculateRemainingDays = (x) => {
  // remaining days function
  const currentDate = new Date();
  const deadlineDate = new Date(x);


  const d1 = currentDate.toLocaleString();
  const d2 = deadlineDate.toLocaleString();
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 mb-4">
                    <div>
                      <p className="text-[0.68rem] uppercase tracking-widest text-slate-600 mb-1">
                        Order #{i + 1}
                      </p>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      {/* Status badge */}
                      <span
                        className={`inline-flex items-center gap-1.5 text-[0.7rem] font-semibold uppercase tracking-wider px-2.5 py-1 rounded-full border ${badgeClass}`}
                      >
                        <span
